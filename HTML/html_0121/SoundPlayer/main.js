...
// window.addEventListener('load',
    // function () {
$(document).ready(function() {  //위에 두줄이 이 줄이랑 같은 말
        //alert("양화영 짱");
        ...
        const createBubbles = function(index)
        {
            ...
            //visual 태그 안에 div 태그 하나 집어 넣는다.
            visual.append(bubble);
            //animation 관련된 건 html 책 참고
            bubble.css('background', colors[index]).css('top','300px').css('animation','animation 200ms linear infinite both')
        }
